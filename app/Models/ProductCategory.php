...
class ProductCategory extends Model
{
    ...
    public function productsByStatus()
    {
        return $this->hasManyThrough('App\Models\Product', 'App\Models\ProductSubCategory', 'category_id', 'subcategory_id')->whereIn('products.status',[1,3]);
    }
