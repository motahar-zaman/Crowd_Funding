		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					Update Content
					<a href="{{route('admin-content-list')}}" class="btn btn-success btn-sm pull-right">コンテンツ一覧</a>
				</div>
				<div class="card-body">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Title" name="title" value="{{$details->title}}" readonly>
							<small class="text-danger">{{ $errors->first('title') }}</small>
						</div>


						<div class="form-group">
							<label for="exampleInputPassword1">詳細内容</label>
