                ...
                <div class="col-10 offset-md-1 bg-white area_auth">
                    <div class="row">
                        <div class="col-6 part_1">
                            ...
                            <form class="form-horizontal" action="{{route('login-cart-action')}}" method="post">
                                {{ csrf_field() }}
                        ...
                        <div class="col-6 part_2">
                            ...
                            <div class="panel-body">
                                <a href="{{route('front-facebook')}}" class="btn btn-primary btn-lg btn-block facebook"><i class="fa fa-facebook"></i> Facebookアカウントでログインする</a>
                                <a href="{{route('front-google')}}" class="btn btn-danger btn-lg btn-block google"><i class="fa fa-google"></i> Googleアカウントでログインする</a>
                                <a href="{{route('front-twitter')}}" class="btn btn-info btn-lg btn-block twitter"><i class="fa fa-twitter"></i> Twitterアカウントでログインする</a>
