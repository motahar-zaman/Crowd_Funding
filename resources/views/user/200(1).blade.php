				...
				<div class="col-md-12">
									<div class="row inner_inner">
										...
										<div class="col-md-7">
											<div class="row ">
												<div class="col-md-8">
													<h6 class="category-name" style="font-size:11px; color:#bfc5cc;"> <span style="color:#bfc5cc;"> <i class="fa fa-tag"></i> </span> ものつくり</h6>
												</div>
												<div class="col-md-4">
													<h6 class="pull-right" style="font-size:11px;"><span style="color:#ed49b6;"> <i class="fa fa-heart"></i> </span>お気に入りに追加</h6>
												</div>
											</div>
											<div class="row mt-1">
												<div class="col-md-12">
