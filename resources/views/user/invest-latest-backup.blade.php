																		...
																		<div class="col-md-12 p-0 mb-4">
																			...
																			<div class="row justify-content-center mt-5">
																				<div class="col-md-4 ">
																					...
																					<button class="offset-md-2 text-center btn btn-md btn-primary  msg_send_btn w6-14" data-user_id="{{ $p->user->id }}" data-project_username="{{ $p->user->first_name .' '.$p->user->last_name }}" style="cursor:pointer; color:#fff;">
