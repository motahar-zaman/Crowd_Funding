												...
												<div class="col-md-6 p-0">
													...
													<div class="row">
														...
														<div class="col-md-offset-6  mr-0 div-radius1 ml-2" style="height: 65px;">
															...
															<button class="bg-yellow editbtn px-3 text-white btn btn-lg btn-block  font-weight-bold w6-18" style=" height:80%;"> <span class="fa fa-shopping-cart px-1"></span> カートに入れる</button>
															{{-- </div> --}}
														</div>
													</div>
												</div>
