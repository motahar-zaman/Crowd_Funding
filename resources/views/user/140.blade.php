											...
											<div class="row inner_inner">
												...
												<div class="row mt-2 btn-row">
													<div class="col-md-6 p-1">
														<button class=" text-white btn btn-md btn-block  w6-14"  style="background-color:#c6c6c6 !important; "> <span class="fa fa-envelope"></span> メッセージを送る</button>
													</div>
													<div class="col-md-6 p-1">
														<button class=" text-white btn btn-md btn-block  w6-14"  style="background-color:#ffbc00 !important; ">★★★  レビューを書く</button>
													</div>
												</div>
