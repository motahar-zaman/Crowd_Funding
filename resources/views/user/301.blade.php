						...
						<div class="col-md-12">
							<div class="row inner_inner">
								...
								<div class="col-md-6">
									<div class="row ">
										<div class="col-md-8">
											<h6 class="category-name" style="color:#bfc5cc;"> <span style="color:#bfc5cc;"> <i class="fa fa-tag"></i> </span> ものつくり</h6>
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-md-offset-6  mr-0 div-radius1 ml-2" style="height: 65px;">
													...
													<button class="px-3 text-white btn btn-lg btn-block w6-18" style="background-color:#ffbc00 !important; height:80%;"> <span class="fa fa-shopping-cart px-1"></span> カートに入れる</button>
													{{-- </div> --}}
												</div>
											</div>
											<div class="row">
