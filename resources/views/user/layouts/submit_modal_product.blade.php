...
<div id="submit-message" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body modal_body_area row">
          ...
          商品登録後は、内容の修正ができません。<br/>
          こちらで登録してよろしいですか？<br/>
          <br/>
          登録後に修正が必要な場合はお問い合わせください。<br/>

          </div>
        
    <div class="col-md-12">
      <h4 class="text-center text-white"> <button id="submit_button_product" type="submit" class="btn btn-warning text-white" style="background:#0099ff;">OK</button></h4>
