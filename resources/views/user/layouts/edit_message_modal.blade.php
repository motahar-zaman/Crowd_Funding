  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body modal_body_area row">
          ...
          お問い合わせは <a href="{{ route('front-contact') }}" >こちら</a>
          <br/>

		     </div>
        
    <div class="col-md-12">
      {{--<h4 class="text-center text-white"> <button id="" type="" class="btn btn-warning text-white" style="background:#0099ff;">OK</button></h4>--}}
