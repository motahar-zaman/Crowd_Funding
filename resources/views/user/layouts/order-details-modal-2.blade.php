<div class="modal fade" style="width:400px; margin:0 auto;" id="order2">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="id" value=""  class="order_id2">
      <input type="hidden" name="detail_id" value=""  class="order_detail_id2">
      <input type="hidden" name="status" value=""  class="status2">

      <div class="modal-body modal_body_area row justify-content-center">
        <h6 class="modal-title px-3 col-8"> キャンセルしますか？ </h6>
        <p class="col-12 mb-0 pb-0  mt-2" style="font-size:15px;">キャンセルする場合は必ず発注者へメッセージを送信してキャンセルしてください。キャンセルすると取引を再開できませんのでご注意ください</p>
        
        <div class="form-group col-md-12 mt-3">
			       <label for="" style="font-size:15px;">メッセージ <strong class="text-danger">必須</strong></label>
             <textarea name="cancel_content" rows="4" cols="80" class="form-control required" placeholder=""required></textarea>
    		</div>
    <div class="col-md-12">
