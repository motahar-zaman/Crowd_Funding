...
<div class="list-group text-center">
    <div class="left_menu_area leftmenuarea">
        <span class="list-group-item text-center" style="font-family: font-family: w6 !important;">
            <strong><i class="fa fa-user-circle user_icon"></i> メッセージ</strong>
        </span>
    ...
    <div>
        <select class="leftmenuarea_sm form-control">
            <option value="{{route('user-message-inbox')}}" {{Route::currentRouteName()=='user-message-inbox'?'selected':''}}>
                受信箱
            </option>
            <option value="{{route('user-message-sent')}}" {{Route::currentRouteName()=='user-message-sent'?'selected':''}}>
                送信済み
            </option>
            <option value="{{route('user-message-trash')}}" {{Route::currentRouteName()=='user-message-trash'?'selected':''}}>
                削除済み
            </option>
        </select>
    </div>
