											...
											<div class="row">
												...
												<div class="col-md-offset-6  mr-0 div-radius1 ml-2" style="height: 65px;">
													...
													{{-- <div class=" div-radius1 m-0 p-0" style="height:50px"> --}}
														<button type="submit" class="px-3 text-white btn btn-lg btn-block w6-18" style="background-color:#ffbc00 !important; height:80%;"> <span class="fa fa-shopping-cart px-1"></span> カートに入れる</button>
													{{-- </div> --}}
												</form>
